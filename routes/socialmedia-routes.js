...
//const newsapiHelper = require("./newsapiHelper.js");
// Require models
...
// function parsenewsapi(data) {
//     var newsapiData = data.response.docs;
//     var newsAPIArticles = [];

//     newsapiData.forEach(function(article) {
//         var { author, title, url, description } = article;
...
module.exports = function(app) {
    ...
    app.post("/api/socialmedia", function(req, res) {
        ...
        var promises = [twitterHelper(twitterHandle), nytimesHelper(companyName)];
